// Simulate phantom.mjs --chat flow
import { runChat } from './chat.mjs';

// Simulate the exact llm object from phantom.mjs
import fs from "fs";
...
console.log('phantomLLM.provider:', phantomLLM.provider);
console.log('phantomLLM.hasLLM:', phantomLLM.hasLLM);

await runChat(phantomLLM);