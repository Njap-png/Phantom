...
function detectNetwork() {
  ...
  try { execFileSync("sh", ["-c", "timeout 3 ping -c 1 -W 2 8.8.8.8 2>/dev/null || timeout 3 curl -s --max-time 3 https://1.1.1.1 >/dev/null 2>&1"], { timeout: 4000 }); info.online = true; } catch {}
  try {
