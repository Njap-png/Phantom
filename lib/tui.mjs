...
export class TUI {
  ...
  enter() {
    ...
    // Set scroll region so conversation scrolls independently — logo and
    // input bar stay fixed while old messages scroll up at the bottom.
  ...
  log(text) {
    ...
    // margin — the terminal scrolls only the region content up by one.
