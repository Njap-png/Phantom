...
export const hackerTools = {
  ...
  install: async (tool) => {
    ...
    if (!name) return "[install] Usage: @install|tool_name. Tools: nmap, sqlmap, metasploit, searchsploit, ffuf, hydra, john, gobuster, nikto, wireshark, subfinder, katana";
    const pmap = {
      ...
      subfinder:"subfinder", katana:"katana",
    };
