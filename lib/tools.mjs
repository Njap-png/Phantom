...
Examples:
  ...
  @hackerone test`;
      ...
      const username = process.env.HACKERONE_API_USERNAME || vaultGet("HACKERONE_API_USERNAME") || cfg.HACKERONE_API_USERNAME || cfg.hackerone_api_username;
      const token = process.env.HACKERONE_API_TOKEN || vaultGet("HACKERONE_API_TOKEN") || cfg.HACKERONE_API_TOKEN || cfg.hackerone_api_token;
