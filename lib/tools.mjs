  ...
  mission: async (input) => {
    try {
      ...
      if (cmd === "execute-next") {
        ...
        const { getExecutionState, EXEC_STATES, transitionState, updateMissionStatus, appendActivity, ensureMissionDirs, saveResult, getResultKey, resultExists, loadExistingResult, saveError } = await import("./recon.mjs");
        ...
        // Map tool to actual function from tools.mjs
        const { subfinder, dnsx, httpx, nuclei, whatweb, tlsx, katana } = await import("./tools.mjs");
        let toolFn;
        switch (tool) {
          case "subfinder": toolFn = subfinder; break;
          case "dnsx": toolFn = dnsx; break;
          case "httpx": toolFn = httpx; break;
          case "nuclei": toolFn = nuclei; break;
          case "whatweb": toolFn = whatweb; break;
          case "tlsx": toolFn = tlsx; break;
          case "katana": toolFn = katana; break;
          default:
