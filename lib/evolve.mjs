...
import { BASE_DIR, TOOLS_DIR, PHANTOM_VERSION, KNOWLEDGE_DIR, PLAYBOOKS_DIR } from "./config.mjs";
import { __r } from "./runtime.mjs";

// ── Constants ──────────────────────────────────────────────
const PHANTOM_DIR = resolve(new URL(".", import.meta.url).pathname, ".."); // project root
